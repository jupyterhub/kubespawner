...
class KubeSpawner(Spawner):
    ...
    image_pull_secrets = Unicode(
        ...
        #specifying-imagepullsecrets-on-a-pod>`__
        See `the Kubernetes documentation <https://kubernetes.io/docs/concepts/containers/images/
