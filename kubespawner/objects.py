...
def make_pod(
    ...
    mem_limit=None,
    mem_guarantee=None,
    arbitrary_resource_limits=None,
    arbitrary_resource_guarantee=None,
    ...
    if arbitrary_resource_guarantee:
        for k in arbitrary_resource_guarantee:
            notebook_container.resources.requests[k] = arbitrary_resource_guarantee[k]
    ...
    if arbitrary_resource_limits:
        for k in arbitrary_resource_limits:
            notebook_container.resources.limits[k] = arbitrary_resource_limits[k]
